...
export default function NovoProdutoPage() {
  ...
  const [variantes, setVariantes] = useState<VarianteForm[]>([
    { cor: "", tamanho: "", codigoBarras: "", precoVenda: "", estoqueMinimo: "0", qtdEstoque: "0" },
  ]);
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setErro(err.message || err.issues?.[0]?.message || "Erro ao cadastrar produto");
        return;
      }
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Cadastre um novo produto com variações</p>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="sm:col-span-2 space-y-2">
                  ...
                  {fotoUrl && !previewUrl && (
                    <p className="text-xs text-muted-foreground">Foto salva: {fotoUrl}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="codigoInterno" name="codigoInterno" placeholder="Código interno do produto" />
                </div>
              </div>
